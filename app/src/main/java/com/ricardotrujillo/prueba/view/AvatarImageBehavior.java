...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ViewGroup> {
    ...
    private void maybeInitProperties(ViewGroup child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = mContext.getResources().getDimensionPixelOffset(R.dimen.spacing_double) + ((int) mCustomFinalHeight / 2);
